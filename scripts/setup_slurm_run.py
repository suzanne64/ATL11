...
import glob
from ATL11.make_slurm_file import make_slurm_file
import argparse
import os
import stat
...
def __main__():
    ...
    parser.add_argument('--environment','-e', type=str, default='ATL11', help="environment that each job will activate")
...
#    ATL11.make_slurm_file(os.path.join(args.run_name, 'slurm_script.sh'),
    make_slurm_file(os.path.join(args.run_name, 'slurm_script.sh'),
