...
for track_file in track_files:
    #if '0079.h5' in track_file:# this is the bad one
    if '0414.h5' in track_file:  # this is the good one.
        for pair in [1,2,3]:
            ...
            P11_list=fit_ATL11(h5_files, beam_pair=pair, seg_x_centers=None, num_centers=200, DOPLOT=None, DEBUG=False) # defined in ATL06_to_ATL11 
            if P11_list:
                D11=ATL11_data(len(P11_list), P11_list[0].N_reps, N_coeffs=9).from_list(P11_list)
