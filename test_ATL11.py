...
m=re.search(r"Track_(.*?).h5",filenames[0])
fileout='Fit_' + m.group(1) + '.h5'
print(fileout)
...
P11_list=fit_ATL11(filenames, beam_pair=3, num_centers=200, seg_x_centers=None , DOPLOT=None, DEBUG=False) # defined in ATL06_to_ATL11  step=60
